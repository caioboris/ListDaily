    ...
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            @if (Route::has('login'))
                @auth
                    <a href="{{ url('/home') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">@lang('welcome.home')</a>
                @else
                    <a href="{{ route('login') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">@lang('welcome.login')</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">@lang('welcome.register')</a>
                    @endif
                @endauth
            @endif
        </div>
